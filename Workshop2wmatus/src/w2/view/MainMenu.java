...
public class MainMenu  {
	...
	public  void deleteBoat() throws Exception{ 
		...
		while(listener.hasNextInt()){ 
			id = listener.nextInt(); 
			if(id<0|| id>club.getSize()||club.getMemberTotalBoats(id)<=0){ 
				System.err.println("The id of the member is invalid ! Try again !");
			}
			else{ 
				break; 
		...
		while(s<club.getMemberTotalBoats(id)){
			ss+=" Id: "+ s +" Type: "+club.getMemberBoatType(id,s)+" Length: "+club.getMemberBoatLength(id, s);
			s++;
		}
		...
		while(listener.hasNextInt()){ 
			...
			if(boatid<0||boatid>club.getMemberTotalBoats(id)){ 
	...
	public void viewMember() throws Exception{
		...
		System.out.println("\n"+"Member id: "+id+"\tName: "+ club.getMemberName(id) +"\t Personalnr:  "+club.getMemberPersonnr(id) +"\t Boats[" + ss+"]");
	...
	public String verboseList(){
		...
		for(int i=0;i<club.getSize();i++){
			...
			while(counter<club.getMemberTotalBoats(i)){
				ss+=" Id: "+ counter +" Type: "+club.getMemberBoatType(i,counter)+" Length: "+club.getMemberBoatLength(i, counter);
				counter++;
			}
			
			s+="\n"+"Member id: "+i+"\tName: "+ club.getMemberName(i) +"\t Personalnr:  "+club.getMemberPersonnr(i) +"\t Boats[" + ss+"]";
	...
	public String compactList(){
		...
		String s="";
		for(int i=0;i<club.getSize();i++){
			 s+="\n"+"Member id: "+i+"\tName: "+ club.getMemberName(i) +"\tBoats: "+ club.getMemberTotalBoats(i);
		}
		return s;
	}
